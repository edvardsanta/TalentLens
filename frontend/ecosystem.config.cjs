module.exports = {
  apps: [{
    ...
    env: {
      NODE_ENV: 'production',
      VITE_UPLOADFILES_API: process.env.VITE_UPLOADFILES_API || 'http://localhost:5095',
      ...
      VITE_UPLOADFILES_WEBSOCKET: process.env.VITE_UPLOADFILES_WEBSOCKET || 'ws://localhost:5095/ws',
      VITE_PLATFORM_API_URL: process.env.VITE_PLATFORM_API_URL || 'http://auth:8080',
